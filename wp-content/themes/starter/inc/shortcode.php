...
// -------------------------------------------------
  ...
  // Large-11
  function col_twelve_fn($atts, $content = null ){	$content = do_shortcode($content);return '<div class="columns large-11">'. $content .'</div>'; }
  add_shortcode( 'col-12', 'col_twelve_fn' );
...
function fullscreen_fn($atts, $text = null) {
  ...
  switch ( $atts['type'] ) :
    ...
    case 'texte' :
    $content .= '<div class="fullscreen fullscreen-texte">';
    ...
    case 'image' :
    $content .= '<div class="fullscreen fullscreen-image" style="background-image:url('. $atts['url'] .')">';
    $content .= '<div class="row">';
    $content .= $text;
    $content .= '</div>';
    $content .= '</div>';
...
add_shortcode( 'fullscreen', 'fullscreen_fn' );
